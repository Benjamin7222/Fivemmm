...
-- Listage de la structure de la base pour base70
CREATE DATABASE IF NOT EXISTS `base70` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `base70`;

-- Listage de la structure de table base70. account_info
...
) ENGINE=MyISAM AUTO_INCREMENT=1690 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- Listage des données de la table base70.account_info : 2 rows
...
-- Listage des données de la table base70.activity : ~0 rows (environ)

-- Listage de la structure de table base70. addon_account
...
-- Listage des données de la table base70.addon_account : ~33 rows (environ)
...
-- Listage de la structure de table base70. addon_account_data
...
-- Listage des données de la table base70.addon_inventory : ~46 rows (environ)
...
-- Listage de la structure de table base70. addon_inventory_items
...
-- Listage des données de la table base70.banlist : ~0 rows (environ)

-- Listage de la structure de table base70. banlisthistory
...
-- Listage des données de la table base70.banlisthistory : ~0 rows (environ)

-- Listage de la structure de table base70. blanchiment
CREATE TABLE IF NOT EXISTS `blanchiment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Listage des données de la table base70.blanchiment : ~0 rows (environ)

-- Listage de la structure de table base70. cardealer_vehicles
CREATE TABLE IF NOT EXISTS `cardealer_vehicles` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6902 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- Listage des données de la table base70.cardealer_vehicles : ~0 rows (environ)
INSERT INTO `cardealer_vehicles` (`id`, `vehicle`, `price`, `society`) VALUES
	(6892, 'mt09', 55000, 'motoshop');

-- Listage de la structure de table base70. car_parking
...
-- Listage des données de la table base70.car_parking : ~0 rows (environ)

-- Listage de la structure de table base70. characters
...
-- Listage des données de la table base70.characters : ~0 rows (environ)

-- Listage de la structure de table base70. clothes_data
...
-- Listage des données de la table base70.clothes_data : ~0 rows (environ)
...
-- Listage de la structure de table base70. coffre_builder
CREATE TABLE IF NOT EXISTS `coffre_builder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Listage des données de la table base70.datastore : ~47 rows (environ)
...
-- Listage de la structure de table base70. datastore_data
...
-- Listage des données de la table base70.data_inventory : ~2 rows (environ)
INSERT INTO `data_inventory` (`id`, `plate`, `data`, `owned`) VALUES
	(1, 'property_9', '{}', 1),
	(2, 'property_10', '{}', 1);

-- Listage de la structure de table base70. drugs
...
-- Listage des données de la table base70.drugs : ~0 rows (environ)
...
-- Listage de la structure de table base70. entreprise
...
-- Listage des données de la table base70.entreprise : ~0 rows (environ)

-- Listage de la structure de table base70. eventspresets
...
-- Listage des données de la table base70.eventspresets : ~0 rows (environ)

-- Listage de la structure de table base70. fav_emote
...
-- Listage des données de la table base70.fav_emote : ~1 rows (environ)
...
-- Listage de la structure de table base70. fine_types
...
-- Listage des données de la table base70.fine_types : ~60 rows (environ)
...
-- Listage de la structure de table base70. fuel_stations
...
-- Listage des données de la table base70.fuel_stations : ~27 rows (environ)
...
-- Listage de la structure de table base70. garage
...
-- Listage des données de la table base70.garage : ~34 rows (environ)
...
-- Listage de la structure de table base70. gksphone_app_chat
...
-- Listage des données de la table base70.gksphone_app_chat : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_bank_transfer
...
-- Listage des données de la table base70.gksphone_bank_transfer : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_blockednumber
...
-- Listage des données de la table base70.gksphone_blockednumber : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_calls
...
-- Listage des données de la table base70.gksphone_calls : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_gallery
...
-- Listage des données de la table base70.gksphone_gallery : ~0 rows (environ)
...
-- Listage de la structure de table base70. gksphone_gotur
...
-- Listage des données de la table base70.gksphone_gotur : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_gps
...
-- Listage des données de la table base70.gksphone_gps : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_group_message
...
-- Listage des données de la table base70.gksphone_group_message : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_insto_accounts
...
-- Listage des données de la table base70.gksphone_insto_accounts : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_insto_instas
...
-- Listage des données de la table base70.gksphone_insto_instas : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_insto_likes
...
-- Listage des données de la table base70.gksphone_insto_likes : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_insto_story
...
-- Listage des données de la table base70.gksphone_insto_story : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_job_message
...
-- Listage des données de la table base70.gksphone_job_message : ~0 rows (environ)
...
-- Listage de la structure de table base70. gksphone_mails
...
-- Listage des données de la table base70.gksphone_mails : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_messages
...
-- Listage des données de la table base70.gksphone_messages : 0 rows
/*!40000 ALTER TABLE `gksphone_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `gksphone_messages` ENABLE KEYS */;

-- Listage de la structure de table base70. gksphone_messages_group
...
-- Listage des données de la table base70.gksphone_messages_group : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_news
...
-- Listage des données de la table base70.gksphone_news : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_settings
...
-- Listage des données de la table base70.gksphone_settings : ~0 rows (environ)
...
-- Listage de la structure de table base70. gksphone_tinderacc
...
-- Listage des données de la table base70.gksphone_tinderacc : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_tindermatch
...
-- Listage des données de la table base70.gksphone_tindermatch : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_tindermessage
...
-- Listage des données de la table base70.gksphone_tindermessage : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_twitter_accounts
...
-- Listage des données de la table base70.gksphone_twitter_accounts : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_twitter_likes
...
-- Listage des données de la table base70.gksphone_twitter_likes : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_twitter_tweets
...
-- Listage des données de la table base70.gksphone_twitter_tweets : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_users_contacts
...
-- Listage des données de la table base70.gksphone_users_contacts : 0 rows
/*!40000 ALTER TABLE `gksphone_users_contacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `gksphone_users_contacts` ENABLE KEYS */;

-- Listage de la structure de table base70. gksphone_vehicle_sales
...
-- Listage des données de la table base70.gksphone_vehicle_sales : ~0 rows (environ)

-- Listage de la structure de table base70. gksphone_yellow
...
-- Listage des données de la table base70.gksphone_yellow : ~0 rows (environ)

-- Listage de la structure de table base70. id_card
...
-- Listage des données de la table base70.id_card : ~0 rows (environ)

-- Listage de la structure de table base70. inside_jobs
...
-- Listage des données de la table base70.inside_jobs : ~0 rows (environ)

-- Listage de la structure de table base70. isdead
CREATE TABLE IF NOT EXISTS `isdead` (
  `id` int(25) DEFAULT NULL,
  `license` varchar(255) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Listage des données de la table base70.isdead : ~0 rows (environ)

-- Listage de la structure de table base70. items
...
-- Listage des données de la table base70.items : ~136 rows (environ)
...
-- Listage de la structure de table base70. jail_player
...
-- Listage des données de la table base70.jail_player : ~0 rows (environ)

-- Listage de la structure de table base70. jobs
...
-- Listage des données de la table base70.jobs : ~36 rows (environ)
...
-- Listage de la structure de table base70. job_grades
CREATE TABLE IF NOT EXISTS `job_grades` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=78418525 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- Listage des données de la table base70.job_grades : ~211 rows (environ)
...
-- Listage des données de la table base70.licenses : ~4 rows (environ)
...
-- Listage de la structure de table base70. newkaizo_houses
CREATE TABLE IF NOT EXISTS `newkaizo_houses` (
  `id` int(11) NOT NULL,
...
-- Listage des données de la table base70.newkaizo_houses : ~0 rows (environ)

-- Listage de la structure de table base70. newkaizo_housesinside
CREATE TABLE IF NOT EXISTS `newkaizo_housesinside` (
  `license` varchar(80) NOT NULL,
  `houseID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Listage des données de la table base70.newkaizo_housesinside : ~0 rows (environ)

-- Listage de la structure de table base70. okokbanking_societies
...
-- Listage des données de la table base70.okokbanking_societies : ~0 rows (environ)
...
-- Listage de la structure de table base70. okokbanking_transactions
...
-- Listage des données de la table base70.okokbanking_transactions : ~8 rows (environ)
...
-- Listage de la structure de table base70. okokbilling
...
-- Listage des données de la table base70.okokbilling : ~0 rows (environ)

-- Listage de la structure de table base70. open_car
...
-- Listage des données de la table base70.open_car : ~38 rows (environ)
...
-- Listage de la structure de table base70. owned_properties
...
-- Listage des données de la table base70.owned_properties : ~0 rows (environ)

-- Listage de la structure de table base70. owned_vehicles
...
-- Listage des données de la table base70.playerstattoos : ~44 rows (environ)
...
-- Listage de la structure de table base70. playlists
...
-- Listage des données de la table base70.playlists : ~0 rows (environ)
INSERT INTO `playlists` (`id`, `label`) VALUES
	(56, 'Kaizo 1');

-- Listage de la structure de table base70. playlist_songs
...
-- Listage des données de la table base70.playlist_songs : ~8 rows (environ)
...
-- Listage de la structure de table base70. prop
...
-- Listage des données de la table base70.prop : ~46 rows (environ)
...
-- Listage de la structure de table base70. property_created
CREATE TABLE IF NOT EXISTS `property_created` (
...
-- Listage des données de la table base70.property_created : ~0 rows (environ)

-- Listage de la structure de table base70. prop_owner
...
-- Listage des données de la table base70.prop_owner : ~0 rows (environ)

-- Listage de la structure de table base70. rented_vehicles
...
-- Listage des données de la table base70.rented_vehicles : ~0 rows (environ)

-- Listage de la structure de table base70. society
...
-- Listage des données de la table base70.society : ~0 rows (environ)

-- Listage de la structure de table base70. society_moneywash
...
-- Listage des données de la table base70.society_moneywash : ~0 rows (environ)

-- Listage de la structure de table base70. truck_inventory2
...
-- Listage des données de la table base70.user_licenses : ~0 rows (environ)

-- Listage de la structure de table base70. vehicles
...
-- Listage des données de la table base70.vehicles : ~265 rows (environ)
...
-- Listage de la structure de table base70. vehicle_categories
...
-- Listage des données de la table base70.vehicle_categories : ~11 rows (environ)
...
-- Listage de la structure de table base70. vehicle_sold
...
-- Listage des données de la table base70.vehicle_sold : ~0 rows (environ)
