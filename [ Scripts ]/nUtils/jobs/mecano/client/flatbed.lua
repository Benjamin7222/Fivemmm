...
AddTextEntry(controllerMessageLoweredCar, "Appuyez sur ~INPUT_CONTEXT~ pour faire ~b~monter ~w~le plateau.~n~Appuyez sur ~INPUT_DETONATE~ pour ~r~détacher ~w~le véhicule.")
AddTextEntry(controllerMessageLoweredNoCar, "Appuyez sur ~INPUT_CONTEXT~ pour faire ~b~monter ~w~le plateau.~n~Appuyez sur ~INPUT_DETONATE~ pour ~g~attacher ~w~le véhicule.")
AddTextEntry(controllerMessageRaised, "Appuyez sur ~INPUT_CONTEXT~ pour faire ~b~descendre ~w~le plateau.")
...
function drawMarker(pos)
    ...
    if dist < 25.0 then
        DrawMarker(6, pos, vector3(0.0, 0.0, 0.0), vector3(-90.0, 0.0, 0.0), vector3(1.0, 1.0, 1.0), 255, 232, 7, 180)
        if dist < 1.5 then
            return true
        end
    end
