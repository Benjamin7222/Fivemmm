...
AddEventHandler('onResourceStart', function(mDrugs)
    if (GetCurrentResourceName() ~= mDrugs) then
        return
    end
    Wait(200)
...
AddEventHandler("Laboratories:AddWaypoint", function(Drugs)
    ESX.ShowAdvancedNotification("Informateur ( Illégal )", "GPS", "Je t'ai placé un point GPS de ton laboratoire, vas y jeter un coup d'oeil.", "CHAR_MALC", 2)
