				...
				if isWeaponBig(weapon) then
					...
					if GetVehiclePedIsIn(playerPed, false) == 0 and DoesEntityExist(vehicle) and IsEntityAVehicle(vehicle) and bigWeaponOut == false then
						...
						if duffle == true then
							...
							if bagIndex == 10 or bagIndex == 11 or bagIndex == 12 or bagIndex == 13 or bagIndex == 45 or bagIndex == 46 or bagIndex == 49 or bagIndex == 50 or accessIndex == 2 or accessIndex == 12 or (accessIndex == 4 and GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_f_freemode_01")) then 
