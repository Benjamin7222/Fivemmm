...
local open = false 
local mainMenu6 = RageUI.CreateMenu('~b~Vestaire', 'Vestiaire')
         ...
         while open do 
            RageUI.IsVisible(mainMenu6,function() 
              ...
              for _,infos in pairs(cfg_sheriff.sheriffCloak.clothes.specials) do
                ...
                RageUI.Separator("Tenues de service ~s~↓")
  ...
  local wait = 750
    ...
    for k in pairs(cfg_sheriff.Position.Vestaire) do
              ...
              if dist <= cfg_sheriff.MarkerDistance then
                  wait = 0
                  DrawMarker(cfg_sheriff.MarkerType, pos[k].x, pos[k].y, pos[k].z-1.0, 0.0, 0.0, 0.0, -90.0,0.0,0.0, cfg_sheriff.MarkerSizeLargeur, cfg_sheriff.MarkerSizeEpaisseur, cfg_sheriff.MarkerSizeHauteur, cfg_sheriff.MarkerColorR, cfg_sheriff.MarkerColorG, cfg_sheriff.MarkerColorB, cfg_sheriff.MarkerOpacite, cfg_sheriff.MarkerSaute, true, p19, cfg_sheriff.MarkerTourne)  
              end
