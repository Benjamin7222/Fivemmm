...
AddEventHandler("sheriff:SendFacture", function(target, price)
	...
	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_sheriff', function(account)
        if account ~= nil then
			...
			TriggerClientEvent("esx:showNotification", target, "Votre compte en banque à été réduit de "..price.."e.", 5000, "danger")
			TriggerClientEvent("esx:showNotification", source, "Vous avez donné une amende de "..price.."e", 5000, "danger")
		end
	end)
end)