...
local open = false 
local mainMenu6 = RageUI.CreateMenu('', '~y~Vestiaire')
     ...
     if open then 
         ...
         while open do 
            RageUI.IsVisible(mainMenu6,function() 
                ...
                RageUI.Button("Reprendre sa tenue : ~y~Civil", nil,{RightLabel = "→"}, true,{
                    onSelected = function()
              ...
              RageUI.Button("Déposer son : ~y~Équipement", nil,{RightLabel = "→"}, true,{
                onSelected = function()
