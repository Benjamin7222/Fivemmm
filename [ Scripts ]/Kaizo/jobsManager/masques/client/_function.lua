_Client = {} or {}
_Client.Function = {} or {}
_Client.Function.Locales = Traduction.Locales[KaizoMasques.Utils.Language];

_Client.Function.Blips = function()
    for _, v in pairs(KaizoMasques.Position) do
        local blip = AddBlipForCoord(v.pos)
        SetBlipSprite(blip, KaizoMasques.Blips.Sprite)
        SetBlipColour(blip, KaizoMasques.Blips.Color)
        SetBlipScale(blip, KaizoMasques.Blips.Scale)
        SetBlipAsShortRange(blip, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString(KaizoMasques.Blips.Name)
