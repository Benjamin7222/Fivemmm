...
ZonesListe = {
    ...
    ["location_start"] = {
        Position = vector3(-1035.18,-2727.87,20.14),
        Public = true,
        Job = nil,
        Job2 = nil,
        Blip = {
    ...
    ["location_btx"] = {
        Position = vector3(1255.29, -2716.02, 2.08),
        Public = true,
        Job = nil,
        Job2 = nil,
        Blip = {
    ...
    ["location_btx2"] = {
        Position = vector3(3945.86, -4636.28, 2.2),
        Public = true,
        Job = nil,
        Job2 = nil,
        Blip = {
    ...
    ["location_btx3"] = {
        Position = vector3(1733.2652587891, 3984.3447265625, 31.978687286377),
        Public = true,
        Job = nil,
        Job2 = nil,
        Blip = {
    ...
    while true do
        ...
        for k,v in pairs(ZonesListe) do
            ...
            if v.Public or ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == v.Job or ESX.PlayerData.job2.name == v.Job2 then
                ...
                if dist < 50.0 then
                    isProche = true
                    DrawMarker(6, v.Position.x, v.Position.y, v.Position.z-0.98, 0.0, 0.0, 0.0, -90.0, 0.0, 0.0, 0.8, 0.8, 0.8, 0, 180, 255, 255, false, false, 2, false, false, false, false)
                end
                if dist < 3 then
