...
RegisterNetEvent("KaizoUI:Popup")
AddEventHandler("KaizoUI:Popup", function(array)
    KaizoUI.Popup(array)
end)
...
---@param array table
---@public
function KaizoUI.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
