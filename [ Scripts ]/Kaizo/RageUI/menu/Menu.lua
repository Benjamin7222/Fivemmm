...
---@return table
---@public
function KaizoUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = KaizoUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = KaizoUI.UI.Style[KaizoUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = KaizoUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + KaizoUI.Settings.Items.Subtitle.Text.X, Menu.Y + KaizoUI.Settings.Items.Subtitle.Text.Y, 0, KaizoUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, KaizoUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, KaizoUI.Menus)
end
...
---@return table
---@public
function KaizoUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function KaizoUI.Menus:SetTitle(Title)
    self.Title = Title
end

function KaizoUI.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function KaizoUI.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function KaizoUI.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function KaizoUI.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function KaizoUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function KaizoUI.Menus:GetStyleSize()
...
---@return void
---@public
function KaizoUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function KaizoUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function KaizoUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function KaizoUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function KaizoUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + KaizoUI.Settings.Items.Subtitle.Text.X, self.Y + KaizoUI.Settings.Items.Subtitle.Text.Y, 0, KaizoUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, KaizoUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function KaizoUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function KaizoUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function KaizoUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function KaizoUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function KaizoUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function KaizoUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function KaizoUI.Menus:Closable(boolean)
...
function KaizoUI.Menus:AddInstructionButton(button)
...
function KaizoUI.Menus:RemoveInstructionButton(button)
...
function KaizoUI.Menus:UpdateInstructionalButtons(Visible)
