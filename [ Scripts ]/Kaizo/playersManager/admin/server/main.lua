...
AddEventHandler("adminmenu:setStaffState", function(newVal, sneaky)
    ...
    local byState = {
        [true] = "[Staff] %s est désormais actif en staffmode.",
        [false] = "[Staff] %s a désactivé son staffmode."
    }
    if newVal then
...
AddEventHandler("adminmenu:tppc", function(target, coords)
    ...
    TriggerClientEvent("esx:showNotification", source, "Téléportation effectuée")
end)
...
AddEventHandler("adminmenu:give", function(target, itemName, qty)
    ...
    if xPlayer then
        ...
        TriggerClientEvent("esx:showNotification", source, ("Give de %sx%s au joueur %s effectué"):format(qty, itemName, GetPlayerName(target)))
        ...
        TriggerClientEvent("esx:showNotification", source, "Ce joueur n'est plus connecté")
    end
end)
...
AddEventHandler("adminmenu:message", function(target, message)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Message envoyé à %s"):format(GetPlayerName(target)))
    TriggerClientEvent("esx:showNotification", target, ("Message du staff: %s"):format(message))
...
AddEventHandler("adminmenu:kick", function(target, message)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Expulsion de %s effectuée"):format(GetPlayerName(target)))
...
AddEventHandler("adminmenu:revive", function(target)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Revive de %s effectué"):format(GetPlayerName(target)))
...
AddEventHandler("adminmenu:heal", function(target)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Heal de %s effectué"):format(GetPlayerName(target)))
...
AddEventHandler("adminmenu:warn", function(target, reason)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Warn envoyé à %s"):format(GetPlayerName(target)))
    TriggerClientEvent("esx:showNotification", target, ("Vous avez reçu un avertissement: %s"):format(reason))
...
AddEventHandler("adminmenu:setGroup", function(target, group)
    ...
    if xPlayer then
        ...
        TriggerClientEvent("esx:showNotification", source, ("Changement du rang de %s effectué"):format(GetPlayerName(target)))
...
AddEventHandler("adminmenu:clearInv", function(target)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Clear inventaire de %s effectuée"):format(GetPlayerName(target)))
...
AddEventHandler("adminmenu:clearLoadout", function(target)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Clear des armes de %s effectuée"):format(GetPlayerName(target)))
    if isWebhookSet(Config.webhook.onClear) then
...
AddEventHandler("adminmenu:addMoney", function(target, ammount)
    ...
    TriggerClientEvent("esx:showNotification", source, ("Give d'argent à %s effectuée"):format(GetPlayerName(target)))
...
AddEventHandler("clearPedTasksEvent", function(source, data)
    local _source = source
    TriggerEvent("BanSql:ICheatServer", _source, "Le cheat ... c'est mal !")
    print("ID: ".._source.." a essayé de truc")
end)
...
AddEventHandler("adminmenu:Jail", function(id, temps)
    ...
    if xPlayer.getGroup() ~= "user" then
        ...
        TriggerEvent("BanSql:ICheatServer", source, "Le cheat ... c'est mal !")
    end
end)
