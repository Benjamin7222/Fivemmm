...
local items = {
    [1] = {name = "Hi-Fi", timeToTake = NewKaizo.second(2), resellerPrice = 500, prop = "as_prop_as_speakerdock", itr = 1.0},
    [2] = {name = "Lampe", timeToTake = NewKaizo.second(5), resellerPrice = 250, prop = "apa_mp_h_floorlamp_a", additionalZ = 1.50, itr = 1.0},
    [3] = {name = "Lampe", timeToTake = NewKaizo.second(5), resellerPrice = 250, prop = "apa_mp_h_lit_floorlampnight_14", additionalZ = 1.50, itr = 1.0},
    [4] = {name = "Plante rare", timeToTake = NewKaizo.second(4), resellerPrice = 150, prop = "apa_mp_h_acc_vase_flowers_01", additionalZ = 1.0, itr = 1.0},
    [5] = {name = "Appareil photo", timeToTake = NewKaizo.second(2), resellerPrice = 1500, prop = "prop_pap_camera_01", itr = 1.0},
    [6] = {name = "Pack d'argent", timeToTake = NewKaizo.second(1), resellerPrice = 3500, prop = "bkr_prop_moneypack_01a", itr = 1.0},
    [7] = {name = "Bijoux rare", timeToTake = NewKaizo.second(2), resellerPrice = 5000, prop = "p_jewel_necklace01_s", itr = 1.0},
    [8] = {name = "Caisse d'argent", timeToTake = NewKaizo.second(30), resellerPrice = 10000, prop = "ex_prop_crate_money_bc", itr = 4.0}
}

NewKaizoSharedRobberiesInteriors = interiors
NewKaizoSharedRobberiesItems = items

NewKaizoSharedRobberies = {
    -- Maison 1 (diamant)
    {
        name = "Maison Diamant",
        interior = 1,
...

    {
        name = "Maison Nord",
        interior = 1,
        entry = vector3(-15.12, 6557.71, 33.24),
        difficultyIndex = 0.3,
        possibleObjects = {
            {3, 1, vector3(-799.6, 327.46, 217.04)},
            {4, 1, vector3(-781.22, 333.35, 217.04)},
...

    {
        name = "Maison Normale",
        interior = 1,
        entry = vector3(-3186.66, 1273.72, 12.65),
        difficultyIndex = 0.2,
        possibleObjects = {
            {3, 1, vector3(-799.6, 327.46, 217.04)},
            {4, 1, vector3(-781.22, 333.35, 217.04)},
