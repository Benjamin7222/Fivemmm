    ...
    CreateThread(function()
        while (isMenuOpen) do
            ...
            RageUI.IsVisible(mainMenu, function()
                ...
                RageUI.Button(('Valider les changements (%s $)'):format(_ClotheConfig.Handler.clothesPrice), nil, { RightBadge = RageUI.BadgeStyle.Tick, Color = {BackgroundColor = { 28, 227, 19, 255 }} }, true, {
