...
Citizen.CreateThread(function()
    while true do
        ...
        if Config.enableMarker then
            if isNearDJ then
                DrawMarker(6, currentDJ.pos.x, currentDJ.pos.y, currentDJ.pos.z -1, 0.0, 0.0, 0.0, -90.0, 0.0, 0.0, 0.8, 0.8, 0.8, 136, 0, 136, 75, false, false, 2, false, false, false, false)
            end
        end
