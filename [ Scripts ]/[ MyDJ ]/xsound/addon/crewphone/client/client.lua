if config.AddonList.crewPhone then
    ...
    exports('Cal', function(link, mp3)
        ...
        if #calanMuzikler <= 99 then
            ...
            ESX.ShowNotification("Les personnes à proximité ne peuvent pas entendre le son de la vidéo que vous avez ouverte car trop de personnes utilisent l'application YouTube.", "error")
        end
    end)
