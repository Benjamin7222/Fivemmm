...
local trunk = RageUI.CreateMenu('', 'Coffre du Unicorn', 10, 10, 'commonmenu', 'interaction_bgd')
local stockplayer = RageUI.CreateSubMenu(trunk, "", "Voici votre ~y~inventaire", 10, 10, 'commonmenu', 'interaction_bgd')
local stockunicorn = RageUI.CreateSubMenu(trunk, "", "Voici ~y~l'inventaire~s~ du Unicorn", 10, 10, 'commonmenu', 'interaction_bgd')
