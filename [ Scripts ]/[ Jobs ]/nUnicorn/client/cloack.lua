...
local cloak = RageUI.CreateMenu('', 'Vestiaire Unicorn :', 10, 10, 'commonmenu', 'interaction_bgd')
        ...
        CreateThread(function()
            while cloakUni do
                ...
                RageUI.IsVisible(cloak, function()
                    ...
                    RageUI.Button(' Reprendre sa ~p~Tenue~s~', nil, {}, true, {
                        onSelected = function()
                    ...
                    RageUI.Button(' Prendre tenue ~p~Barman~s~', nil, {}, true, {
                        onSelected = function()
                    ...
                    RageUI.Button(' Prendre tenue ~p~Danseur~s~', nil, {}, true, {
                        onSelected = function()
                            SetPedComponentVariation(GetPlayerPed(-1), 8, 58, 0) -- (T-shirt)
                            SetPedComponentVariation(GetPlayerPed(-1), 11, 55, 0) -- (Torse)
                            SetPedComponentVariation(GetPlayerPed(-1), 10, 0, 0) -- (Badge)
