...
local uniF6 = RageUI.CreateMenu('', 'Menu Intéraction :', 10, 10, 'commonmenu', 'interaction_bgd')
local annonce = RageUI.CreateSubMenu(uniF6, '', 'Annonce Unicorn :', 10, 10, 'commonmenu', 'interaction_bgd')
local farm = RageUI.CreateSubMenu(uniF6, '', 'Point de Farm Unicorn :', 10, 10, 'commonmenu', 'interaction_bgd')
        ...
        CreateThread(function()
            while MenuUni do
                ...
                RageUI.IsVisible(uniF6, function()
                    RageUI.Checkbox(''..labelService, nil, OnService, {}, {
                        onChecked = function()
                            OnService = true
                    ...
                    if OnService then
                        RageUI.Button('Annonces', nil, {}, true, {}, annonce)
                        RageUI.Button('Points de Farms', nil, {}, true, {}, farm)
                    end
                end)

                RageUI.IsVisible(annonce, function()
                    RageUI.Button('Anonce ~g~Ouverture~s~', nil, {}, true, {
                        onSelected = function()
                            TriggerServerEvent('Barwoz:annonceUni', 'Le Unicorn est désormais OUVERT !')
                        end
                    })
                    RageUI.Button('Anonce ~r~Fermeture~s~', nil, {}, true, {
                        onSelected = function()
                            TriggerServerEvent('Barwoz:annonceUni', 'Le Unicorn est désormais FERMER !')
                        end
                    })
                    RageUI.Button('Anonce ~o~Personalisé~s~', nil, {}, true, {
                        onSelected = function()
                ...
                RageUI.IsVisible(farm, function()
                    ...
                    RageUI.Button('Point de Récolte', nil, {}, true, {
                        onSelected = function()
                            SetNewWaypoint(137.90, -3110.81, 5.89)
                        end
                    })

                    RageUI.Button('Point de Traitement', nil, {}, true, {
                        onSelected = function()
                            SetNewWaypoint(-51.05, 1901.11, 195.36)
                        end
                    })

                    RageUI.Button('Point de Vente', nil, {}, true, {
                        onSelected = function()
                            SetNewWaypoint(-708.36, -904.75, 19.21)
                        end
                    })

                    RageUI.Button('Points des Courses', nil, {}, true, {
                        onSelected = function()
