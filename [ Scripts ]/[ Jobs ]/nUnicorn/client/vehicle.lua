...
local vehMenu = RageUI.CreateMenu('', 'Véhicule du Unicorn :', 10, 10, 'commonmenu', 'interaction_bgd')
        ...
        CreateThread(function()
            while VehUni do
                ...
                RageUI.IsVisible(vehMenu, function()
                    ...
                    RageUI.List(' Sortir un Véhicule', {'~b~T20~s~', '~b~Bisson~s~', '~b~Limousine~s~'}, Index.List1, nil, {}, true, {
