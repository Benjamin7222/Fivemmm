...
ESX.ShowNotification = function(msg)
    ...
    elseif title ~= nil and time == nil then
        exports['okokNotify']:Alert(title, msg, 5000, 'info')
    elseif title ~= nil and time ~= nil and type == nil then
...
ESX.ShowAdvancedNotification = function(sender, subject, msg, textureDict, iconType, flash, saveToBrief, hudColorIndex)
    exports['okokNotify']:Alert(subject, msg, 5000, 'info')
end

ESX.ShowHelpNotification = function(msg, key)
    TriggerEvent("ui:interaction", msg, key)
end
