Locales['fr'] = {
	...
	['gave_weapon_ammo'] = 'vous avez donné %sx balles pour %s à %s',
	['gave_weapon_withammo'] = 'vous avez donné 1x %s avec %sx balles à %s',
	['gave_weapon_hasalready'] = '%s a déjà %s',
	['gave_weapon_noweapon'] = '%s n\'a pas cette arme',
	['received_weapon'] = 'vous recevez 1x %s de %s',
	['received_weapon_ammo'] = 'vous avez reçu %sx balles pour votre %s de %s',
	['received_weapon_withammo'] = 'vous avez reçu 1x %s avec %sx balles de %s',
	...
	['gave_money'] = 'vous avez donné $%s à %s',
	['received_money'] = 'vous avez reçu $%s par %s',
	...
	['money_set'] = 'quelqu\'un de haut placé vous a attribué $%s (%s) !',
